...
* 热平衡时，三维经典粒子，热力学系统中无相互作用粒子的速度分布函数为 $f(\vec{v}) = (\frac{m}{2\pi k_B T})^{\frac{3}{2}}e^{-\frac{mv^2}{2k_BT}},k_B = \frac{R}{N_A} = 1.38 \times 10^{-23} J/K$$k_B$ 为玻尔兹曼常量，$m$ 为单个粒子质量，对于确定的粒子 $f$ 与 $v$ 方向无关
